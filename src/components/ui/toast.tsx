...
>(({ className, variant = 'default', ...props }, ref) => {
  const variantClasses = {
    default: 'bg-background-light border-gray-600',
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      'inline-flex h-8 shrink-0 items-center justify-center rounded-md border border-gray-600',
      'bg-transparent px-3 text-sm font-medium transition-colors',
      'hover:bg-background-lighter focus:outline-none focus:ring-2 focus:ring-primary-500',
      className
    )}
    {...props}
  />
